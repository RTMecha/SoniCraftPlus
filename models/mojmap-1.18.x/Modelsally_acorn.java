...
public class Modelsally_acorn<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sally_acorn"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 4)
						...
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 36)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F)).texOffs(0, 1)
						.addBox(-4.0F, -10.0F, -3.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(2.0F, -10.0F, -3.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 5)
						.addBox(-4.5F, -4.0F, -3.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(24, 5)
						.mirror().addBox(1.5F, -4.0F, -3.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 10.0F, 0.0F));

		PartDefinition hairtop = head.addOrReplaceChild("hairtop",
				CubeListBuilder.create().texOffs(32, 0).addBox(-2.0F, -3.0F, -5.0F, 4.0F, 5.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.75F, -0.25F, -0.6109F, 0.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 22)
						.addBox(-1.5F, -2.0F, -1.0F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 30)
						.addBox(-1.5F, -2.0F, -1.0F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition hipR = partdefinition.addOrReplaceChild("hipR",
				CubeListBuilder.create().texOffs(52, 21)
						.addBox(-1.5F, 3.25F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 24)
						.addBox(-2.0F, 7.0F, -4.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(22, 16)
						.addBox(-1.0F, -0.25F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.25F)),
		...
		PartDefinition hipL = partdefinition.addOrReplaceChild("hipL", CubeListBuilder.create().texOffs(22, 16).mirror()
				...
				.texOffs(34, 24).mirror().addBox(-2.0F, 7.0F, -4.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(52, 21).mirror()
				.addBox(-1.5F, 3.25F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(1.0F, 15.0F, 0.0F));
