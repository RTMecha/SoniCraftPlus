...
public class Modelmighty<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mighty"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 4)
						.addBox(-0.5F, -3.0F, -5.75F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-4.5F, -9.0F, -2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 1)
		...
		PartDefinition back = body.addOrReplaceChild("back",
				CubeListBuilder.create().texOffs(49, 21).addBox(-2.0F, -3.0341F, -1.2412F, 4.0F, 6.0F, 3.0F,
		...
		PartDefinition hipR = partdefinition.addOrReplaceChild("hipR",
				CubeListBuilder.create().texOffs(22, 16)
						.addBox(-1.0F, -1.25F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.25F)).texOffs(16, 26)
						.addBox(-2.0F, 4.25F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.25F)).texOffs(34, 24)
		...
		PartDefinition hipL = partdefinition.addOrReplaceChild("hipL", CubeListBuilder.create().texOffs(22, 16).mirror()
				.addBox(-1.0F, -1.25F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.25F)).mirror(false)
				.texOffs(16, 26).mirror().addBox(-2.0F, 4.25F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(-0.25F))
