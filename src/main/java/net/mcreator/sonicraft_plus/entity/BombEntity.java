...
import net.mcreator.sonicraft_plus.procedures.BombOnEntityTickUpdateProcedure;
...
public class BombEntity extends Monster implements GeoEntity {
	...
	public BombEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SonicraftPlusModEntities.BOMB.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(SonicraftPlusModEntities.BOMB.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
