...
public class SeedrianSeedRightClickedOnBlockProcedure {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.FLOWER_POT) {
			{
				...
				BlockState _bs = SonicraftPlusModBlocks.COSMO_FLOWER_POT.get().defaultBlockState();
			...
			if ((new Object() {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(SonicraftPlusModItems.SEEDRIAN_SEED.get());
