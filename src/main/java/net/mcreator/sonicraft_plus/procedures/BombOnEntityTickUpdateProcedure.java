...
public class BombOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (Entity_in_range) {
			...
			if (!(entity instanceof LivingEntity _livEnt8 && _livEnt8.hasEffect(SonicraftPlusModMobEffects.FUSE.get()))) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(SonicraftPlusModMobEffects.FUSE.get(), 25, 1, false, false));
				if (entity instanceof LivingEntity _livEnt10 && _livEnt10.hasEffect(SonicraftPlusModMobEffects.FUSE.get())) {
					{
						int _value = 3;
			...
			if (entity instanceof LivingEntity _entity)
				_entity.removeEffect(SonicraftPlusModMobEffects.FUSE.get());
		}
	}
}
