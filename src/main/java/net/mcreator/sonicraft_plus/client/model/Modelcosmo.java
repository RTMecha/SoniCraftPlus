...
public class Modelcosmo<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("sonicraft_plus", "modelcosmo"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition
				.addOrReplaceChild("head",
						CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F)).texOffs(0, 30)
								.addBox(4.0F, -7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 30).mirror().addBox(-6.0F, -7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition hipR = partdefinition.addOrReplaceChild("hipR", CubeListBuilder.create().texOffs(22, 16).addBox(-1.0F, -1.25F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(-0.25F)).texOffs(14, 26)
				.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(34, 24).addBox(-2.0F, 6.0F, -4.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 16.0F, 0.0F));
		PartDefinition hipL = partdefinition.addOrReplaceChild("hipL",
				CubeListBuilder.create().texOffs(22, 16).mirror().addBox(-1.0F, -1.25F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(-0.25F)).mirror(false).texOffs(14, 26).mirror()
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(34, 24).mirror().addBox(-2.0F, 6.0F, -4.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(1.0F, 16.0F, 0.0F));
		PartDefinition shoulderR = partdefinition.addOrReplaceChild("shoulderR",
				CubeListBuilder.create().texOffs(14, 16).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 16).addBox(-3.0F, 2.9696F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.5F)),
		...
		PartDefinition shoulderL = partdefinition.addOrReplaceChild("shoulderL", CubeListBuilder.create().texOffs(14, 16).mirror().addBox(0.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(36, 16).mirror()
				.addBox(-1.0F, 2.9696F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(2.0F, 11.0F, 0.0F, 0.0F, 0.0F, -0.2618F));
