...
package net.mcreator.sonicraft_plus.world.dimension;
...
public class PlanetWispDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class PlanetWispSpecialEffectsHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("sonicraft_plus:planet_wisp"), customEffect);
		}
	}
}
