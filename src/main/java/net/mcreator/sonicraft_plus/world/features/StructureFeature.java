package net.mcreator.sonicraft_plus.world.features;
...
import net.mcreator.sonicraft_plus.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, SonicraftPlusMod.MODID);
